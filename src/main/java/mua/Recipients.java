...
/**
 * Represents a collection of email recipients. Implements the Iterable interface to enable
 * iteration over the recipients.
 */
public class Recipients implements Iterable<Address> {
   ...
   *
   * <p>The addresses list is initialized as an empty ArrayList.
   */
  public Recipients() {
