...
public class Base64Encoding {
   ...
   */
  public static ASCIICharSequence encode(final String data) throws NullPointerException {
  ...
  /**
   * Encodes a word to an <em>encoded-word</em> according to the RFC 2047.
   *
   * @param word the word to encode.
   * @return the <em>encoded-word</em> according to the RFC 2047.
   * @throws NullPointerException if the word is {@code null}.
   */
  public static ASCIICharSequence encodeWord(final String word) throws NullPointerException {
    return ASCIICharSequence.of(
        "=?utf-8?B?"
